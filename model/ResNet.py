# -*- coding: utf-8 -*-
# @Time         : 2024/12/25 22:32
# @Author       : Song Zilong
# @Software     : PyCharm
# @Description  : ResNet实现
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = torchvision.models.resnet.conv3x3(3, 64)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = torchvision.models.resnet.conv3x3(in_planes, planes, stride)
